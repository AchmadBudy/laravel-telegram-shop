...
class TelegramService
{
    ...
    public function registerCommand($idUser, $username, $firstName, $lastName): array
    {
        ...
        return $this->sendMessage(
            ...
            Jika ada pertanyaan, silahkan hubungi admin. @{$teleSettings->owner_username}Untuk melihat stock, cara order, informasi, dan cara deposit silahkan klik tombol dibawah.
            atau bisa ketik stock untuk melihat stock produk.
            atau ketik cara order untuk melihat cara order produk.
            dan ketik cara deposit untuk melihat cara deposit.
