...
class IncreamentProductQuery extends AbstractQuery
{
    protected static string $regex = '/increament_product/';
    ...
    public function handle(UpdateEvent $event): mixed
    {
        ...
        $response = $telegramService->showOrderProduct($productId, amount: $amount, increament: true);
